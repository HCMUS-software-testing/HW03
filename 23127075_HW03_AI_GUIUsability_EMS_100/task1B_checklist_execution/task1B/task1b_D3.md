...
| F-D3-001 | `../screenshots/checklist-failures/F-D3-001_search-title-returns-extra-result.png` | Search theo title cụ thể vẫn trả thêm request không liên quan. |
| F-D3-002 | `../screenshots/checklist-failures/F-D3-002_tab-switch-loses-filter-context.png` | Đổi tab từ trạng thái đang filter làm mất search/member-code/category filter. |
| F-D3-003 | `../screenshots/checklist-failures/F-D3-003_mobile-sidebar-overflow.png` | Mobile admin layout bị sidebar chiếm chỗ, content bị bó hẹp và khó đọc. |
