...
| F-D1-001 | `../screenshots/checklist-failures/F-D1-001_validation-not-inline.png` | Validation field bắt buộc dùng alert chung và submit vẫn bật khi form rỗng. |
| F-D1-002 | `../screenshots/checklist-failures/F-D1-002_category-submit-400-no-clear-ui-error.png` | Lỗi submit category/default và recovery message chưa rõ. |
| F-D1-003 | `../screenshots/checklist-failures/F-D1-003_cancel-discards-without-confirmation.png` | Cancel quay về danh sách không xác nhận dù form đã có dữ liệu. |
