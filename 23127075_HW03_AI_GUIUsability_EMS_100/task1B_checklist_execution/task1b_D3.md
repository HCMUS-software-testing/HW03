...
| --- | --- | --- |
| Đọc bối cảnh HW03 | Shell `rtk` | Đã đọc tài liệu trong `docs/`, `test access notes used during execution`, checklist final, D1 và D2 để giữ đúng phạm vi Scenario D và format báo cáo. |
...
| --- | --- | --- |
| E-D3-001 | `../screenshots/D3/D3_pending_overview.png` | Tổng quan D3 Pending tab ở desktop, có request test của Kiên. |
| E-D3-002 | `../screenshots/D3/D3_member_code_filter_kien_pending.png` | Member-code filter `G18D126AA` cô lập request Pending của Kiên. |
| E-D3-003 | `../screenshots/D3/D3_category_support_filter.png` | Category filter `Support` kết hợp member-code filter. |
| E-D3-004 | `../screenshots/D3/D3_resolved_tab_overview.png` | Resolved tab hiển thị danh sách resolved requests và count. |
| E-D3-005 | `../screenshots/D3/D3_no_matching_requests.png` | No-result state khi search không có kết quả. |
| F-D3-001 | `../findings/defect-screenshots/F-D3-001_search-title-returns-extra-result.png` | Search theo title cụ thể vẫn trả thêm request không liên quan. |
| F-D3-002 | `../findings/defect-screenshots/F-D3-002_tab-switch-loses-filter-context.png` | Đổi tab từ trạng thái đang filter làm mất search/member-code/category filter. |
| F-D3-003 | `../findings/defect-screenshots/F-D3-003_mobile-sidebar-overflow.png` | Mobile admin layout bị sidebar chiếm chỗ, content bị bó hẹp và khó đọc. |
...
- Các finding D3 ở trên đã được đối chiếu với `../findings/bug_usability_findings_log.md` và đã có `Form-submission timestamp`.
