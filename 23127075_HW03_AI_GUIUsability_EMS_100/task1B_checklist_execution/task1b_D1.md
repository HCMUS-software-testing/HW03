...
- Dùng checklist gốc `../../task1A_group_checklist/group/gui_usability_checklist_final.md` làm checklist thực thi.
- Không sửa `../../task1A_group_checklist/group/gui_usability_checklist_final.md`.
- Dùng thông tin URL/tài khoản trong `test access notes used during execution`.
- Tuyệt đối tuân thủ Testing Rules trong `test access notes used during execution`: chỉ dùng tài khoản user của Kiên cho D1/D2, không thao tác dữ liệu hoặc tài khoản người khác, chỉ tạo support request test của chính tài khoản Kiên nếu cần.
...
Quy trình D1:
1. Mở EMS tại URL mới trong `test access notes used during execution`.
...
6. Chạy từng item trong `../../task1A_group_checklist/group/gui_usability_checklist_final.md` trên riêng màn hình D1.
...
| --- | --- | --- |
| E-D1-001 | `../screenshots/D1/D1_create_request_overview.png` | Tổng quan D1 trước khi nhập dữ liệu. |
| E-D1-002 | `../screenshots/D1/D1_form_filled_with_attachment.png` | Form đã điền và có ảnh upload. |
| E-D1-003 | `../screenshots/D1/D1_mobile_validation_layout.png` | Layout mobile và trạng thái validation ở `390x844`. |
| E-D1-004 | `../screenshots/D1/D1_submit_success_redirect.png` | Redirect sau submit thành công và request mới trong danh sách. |
| F-D1-001 | `../findings/defect-screenshots/F-D1-001_validation-not-inline.png` | Validation field bắt buộc dùng alert chung và submit vẫn bật khi form rỗng. |
| F-D1-002 | `../findings/defect-screenshots/F-D1-002_category-submit-400-no-clear-ui-error.png` | Lỗi submit category/default và recovery message chưa rõ. |
| F-D1-003 | `../findings/defect-screenshots/F-D1-003_cancel-discards-without-confirmation.png` | Cancel quay về danh sách không xác nhận dù form đã có dữ liệu. |
...
| Không đạt | 12 |
| Không áp dụng | 12 |
| Đã submit Google Form | 4 findings |
...
- Các finding D1 ở trên đã được đối chiếu với `../findings/bug_usability_findings_log.md` và đã có `Form-submission timestamp`.
