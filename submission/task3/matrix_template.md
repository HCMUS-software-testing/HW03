...
| D1-CP-04 | Android | Samsung Internet | Tablet | Samsung Galaxy Tab A + Samsung Internet | `[Pass/Fail]` | `submission/task3/screenshots/D1_CP-04_android_samsung-internet_tablet.png` | Tablet layout, form readability, action buttons. | `[Điền sau khi test]` |
| D1-CP-05 | Android | Chrome | Phone | Samsung Galaxy A54 + Chrome | `[Pass/Fail]` | `submission/task3/screenshots/D1_CP-05_android_chrome_phone.png` | Textarea/input rendering, upload button, no horizontal overflow trên phone. | `[Điền sau khi test]` |
...
| D2-CP-04 | Android | Samsung Internet | Tablet | Samsung Galaxy Tab A + Samsung Internet | `[Pass/Fail]` | `submission/task3/screenshots/D2_CP-04_android_samsung-internet_tablet.png` | Tablet list/detail layout and filter controls. | `[Điền sau khi test]` |
| D2-CP-05 | Android | Chrome | Phone | Samsung Galaxy A54 + Chrome | `[Pass/Fail]` | `submission/task3/screenshots/D2_CP-05_android_chrome_phone.png` | Search/filter and card readability on phone. | `[Điền sau khi test]` |
...
| D3-CP-04 | Android | Samsung Internet | Tablet | Samsung Galaxy Tab A + Samsung Internet | `[Pass/Fail]` | `submission/task3/screenshots/D3_CP-04_android_samsung-internet_tablet.png` | Tablet sidebar/content layout and filter usability. | `[Điền sau khi test]` |
| D3-CP-05 | Android | Chrome | Phone | Samsung Galaxy A54 + Chrome | `[Pass/Fail]` | `submission/task3/screenshots/D3_CP-05_android_chrome_phone.png` | Mobile admin layout, sidebar/content width, filter usability trên phone. | `[Điền sau khi test]` |
