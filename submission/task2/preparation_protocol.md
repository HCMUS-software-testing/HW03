...
Theo `submission/test_environment_access.md`, chỉ dùng account và dữ liệu được phép cho Scenario D. Nếu tạo account user tạm cho participant, ghi account alias trong `test_accounts_template.md`, nhưng không đưa password thật vào báo cáo nộp Moodle.
