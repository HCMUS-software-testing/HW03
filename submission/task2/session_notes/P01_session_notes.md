...
| Evidence      | `submission/task2/session_notes/image/P01_session_notes/1785821851780.png` |
...
| ---------- | -------------- | ------------------- | ------------ | ---------------- | -----------: | ----------------------- |
| UT-P01-001 | `D3` | `Usability` | Request description chứa chuỗi dài không tự xuống dòng, bị tràn ngang khỏi khung nội dung và làm giảm khả năng đọc khi xử lý request. | `submission/task2/session_notes/image/P01_session_notes/1785821851780.png`; participant ghi nhận: `Request description nội dung bị tràn ra` | 2 | `No` |
