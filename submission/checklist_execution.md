# Phụ lục - Task 1B: Thực thi checklist (kiểm thử lại trực tiếp)
...
| Đường dẫn trong đề | Đường dẫn ngrok trả về 404; không dùng làm nguồn kết quả |
| Tài khoản/vai trò | Tài khoản `Admin` được cung cấp; không ghi thông tin đăng nhập vào tài liệu |
...
| Bản nháp | `23127326_TASK1B_20260802_163308`, id=80; đã `Save as Draft`, không `Publish`, không `Delete` |
...
| --- | --- | --- | --- | --- | --- |
| A1 | Danh sách sự kiện có bộ lọc trạng thái và chấm thông báo | Tìm kiếm, lọc, đặt lại, phân trang, thông báo, điều hướng và kiểm tra khả năng thích ứng | [Danh sách sự kiện](https://prod-dev.ems-fitus.cloud/dashboard/admin/events) | Quản trị viên | ![Tổng quan A1](screenshots/task1b/a1-overview.png) |
| A2 | Biểu mẫu Thêm/Sửa sự kiện | Kiểm tra trường, ngày giờ, tải ảnh, văn bản định dạng, lưu và mở lại | [Tạo mới](https://prod-dev.ems-fitus.cloud/dashboard/admin/events/create); [bản nháp ID 80](https://prod-dev.ems-fitus.cloud/dashboard/admin/events/edit?id=80) | Quản trị viên | ![Tổng quan A2](screenshots/task1b/a2-overview.png) |
| A3 | Bảng cấu hình Đăng ký và vai trò | Cấu hình `Max Slots`, vai trò, `Waitlist`, `Additional Role`, `Reminder` và các quan hệ phụ thuộc | [Bản nháp ID 80](https://prod-dev.ems-fitus.cloud/dashboard/admin/events/edit?id=80) | Quản trị viên | ![Tổng quan Đăng ký A3](screenshots/task1b/a3-overview-registration.png) ![Tổng quan Vai trò bổ sung A3](screenshots/task1b/a3-overview-additional.png) |

## 3. Cách đánh dấu

- **Đạt:** tiêu chí áp dụng và đã được kiểm thử trực tiếp đầy đủ mà không thấy vi phạm.
- **Không đạt:** thao tác tương tác xác nhận vi phạm; phải có ghi chú cụ thể, mã phát hiện và ảnh minh chứng thật.
- **Không áp dụng:** tiêu chí không tồn tại trong màn hình/luồng; phải ghi lý do riêng theo màn hình.
- Không cần ghi chú hoặc ảnh riêng cho mục `Đạt`. Tỷ lệ đạt = `Đạt / (Đạt + Không đạt)`.
- Mỗi màn hình dùng một bảng riêng theo đúng cấu trúc sáu cột tại commit `d655d24e9dc92adb3b09783d18ec56cb84852189`.

## 4. Thực thi checklist

### 4.1 A1 Danh sách sự kiện
