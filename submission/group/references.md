# Nguồn tham khảo cho checklist GUI dùng chung

| Nguồn | Cách sử dụng |
| --- | --- |
| Jakob Nielsen, "10 Usability Heuristics for User Interface Design", Nielsen Norman Group, https://www.nngroup.com/articles/ten-usability-heuristics/ | Đối chiếu visibility of system status, consistency, error prevention, recognition rather than recall và recovery from errors |
| Ben Shneiderman, "The Eight Golden Rules of Interface Design", University of Maryland, https://www.cs.umd.edu/users/ben/goldenrules.html | Đối chiếu consistency, universal usability, informative feedback, preventing errors, closure và reducing memory load |
